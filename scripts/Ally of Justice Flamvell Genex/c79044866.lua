...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	local ct=Duel.GetMatchingGroup(s.spcostfilter1,tp,LOCATION_HAND|LOCATION_DECK|LOCATION_EXTRA|LOCATION_ONFIELD,0,nil):GetClassCount(Card.GetCode)
	...
	--Duel.SetOperationInfo(0,CATEGORY_REMOVE,nil,lvl,tp,LOCATION_HAND|LOCATION_DECK|LOCATION_EXTRA|LOCATION_ONFIELD)
